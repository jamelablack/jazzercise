...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { City: @workshop.City, Complete: @workshop.Complete, CountryObjectID: @workshop.CountryObjectID, DistrictObjectID: @workshop.DistrictObjectID, ObjectID: @workshop.ObjectID, StateObjectID: @workshop.StateObjectID, TrainerObjectID: @workshop.TrainerObjectID, WorkshopEndDate: @workshop.WorkshopEndDate, WorkshopStartDate: @workshop.WorkshopStartDate }
    end
  ...
  test "should update workshop" do
    put :update, id: @workshop, workshop: { City: @workshop.City, Complete: @workshop.Complete, CountryObjectID: @workshop.CountryObjectID, DistrictObjectID: @workshop.DistrictObjectID, ObjectID: @workshop.ObjectID, StateObjectID: @workshop.StateObjectID, TrainerObjectID: @workshop.TrainerObjectID, WorkshopEndDate: @workshop.WorkshopEndDate, WorkshopStartDate: @workshop.WorkshopStartDate }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
